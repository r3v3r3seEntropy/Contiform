...
# Default spherical harmonic coefficient file (IGRF13). First, check if the user provided an
# override via the environment variable "MAGNAV_SHC_FN"; otherwise fall back to the packaged
# path. Update this to point to your actual file location.

# 1) Environment variable takes precedence.
# 2) If not set, use the path below (update if your file lives elsewhere).

# NOTE: On Windows paths, use forward slashes or raw strings to avoid escape-sequence issues.
